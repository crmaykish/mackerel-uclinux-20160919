...
#define	GPIO_USB_OVC	31 /* gpio 47 is over current */
#define	USB_PWR_ON	GPIO_ON
#define	USB_PWR_OFF	GPIO_OFF
#define	USB_OVC_TRUE	GPIO_OFF
#else
...
static void accelerated_usboc_handler(unsigned long data)
{
	static int count_down = 0;
	static DEFINE_TIMER(accelerated_usboc_timer, accelerated_usboc_handler, 0, 0);
