...
#endif
#if IS_ENABLED(CONFIG_BROADCOM_BCM53118)
	void			*bcm53118_ptr;	/* BCM53118 specific data */
#endif
...
static inline bool netdev_uses_bcm53118_tags(struct net_device *dev)
{
#if IS_ENABLED(CONFIG_BROADCOM_BCM53118)
	if (dev->bcm53118_ptr != NULL)
		return 1;
#endif
