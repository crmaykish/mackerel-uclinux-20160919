...
{
	u32 i, addr, cext, mdic, mdicnfg;
	s32 ret_val = 0;

	cext = rd32(E1000_CTRL_EXT);
	...
	if (offset >> 16) {
		addr = (offset >> 16);
		if (addr >= 32) {
			wr32(E1000_MDICNFG, mdicnfg | E1000_MDICNFG_EXT_MDIO);
			wr32(E1000_CTRL_EXT, cext | E1000_CTRL_I2C_ENA);
		}
		addr &= 0x1f;
	}
	offset &= 0xffff;
	 ...
	 */
	i = rd32(E1000_MDICNFG);
	i &= ~E1000_MDICNFG_PHY_MASK;
	i |= (addr << E1000_MDICNFG_PHY_SHIFT);
	wr32(E1000_MDICNFG, i);

	mdic = (offset << E1000_MDIC_REG_SHIFT) | (E1000_MDIC_OP_READ);
