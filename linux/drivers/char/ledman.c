...
/****************************************************************************/
/****************************************************************************/
#if defined(CONFIG_MACH_6300_EX_DT)
/****************************************************************************/

#include <linux/gpio.h>

/*
 * Here is the GPIO line definition of the LEDs on the 6300-EX.
 */
#define LED_D3_RD   0x01  /* RED 1 */
#define LED_D3_BL   0x02  /* BLUE 1 */
#define LED_D3_GR   0x04  /* GREEN 1 */
#define LED_D6_RD   0x08  /* RED 2 */
#define LED_D6_BL   0x10  /* BLUE 2 */
#define LED_D6_GR   0x20  /* GREEN 2 */
#define LED_D4      0x40  /* SS1 */
#define LED_D5      0x80  /* SS2 */
#define LED_D7      0x100 /* SS3 */
#define LED_D8      0x200 /* SS4 */
#define LED_D9      0x400 /* SS5 */
#define LEDMASK     0x7ff
#define LED_NR      11
...
static struct ledgpiomap ledgpio[] = {
	{ .name = "Red1", .gpio = 8, },		/* LED D3_RED */
	{ .name = "Blue1", .gpio = 9, },	/* LED D3_BLUE */
	{ .name = "Green1", .gpio = 13, },	/* LED D3_GREEN */
	{ .name = "Red2", .gpio = 14, },	/* LED D6_READ */
	{ .name = "Blue2", .gpio = 16, },	/* LED D6_BLUE */
	{ .name = "BACKUP", .gpio = 35, },	/* LED D6_GREEN */
	{ .name = "RSS1", .gpio = 40, },	/* LED D4 */
	{ .name = "RSS2", .gpio = 41, },	/* LED D5 */
	{ .name = "RSS3", .gpio = 42, },	/* LED D7 */
	{ .name = "RSS4", .gpio = 43, },	/* LED D8 */
	{ .name = "RSS5", .gpio = 44, },	/* LED D9 */
};

static ledmap_t	ledman_std = {
	[LEDMAN_ALL]       = LEDMASK,

	[LEDMAN_HEARTBEAT] = LED_D3_GR,
	...
	[LEDMAN_NVRAM_1]   = LED_D3_RD | LED_D6_RD | LED_D4 | LED_D7 | LED_D9,
	[LEDMAN_NVRAM_2]   = LED_D3_RD | LED_D3_GR | LED_D6_RD | LED_D6_GR |
	                     LED_D5 | LED_D8,
	[LEDMAN_NVRAM_ALL] = LED_D3_RD | LED_D3_GR | LED_D6_RD | LED_D6_GR |
	                     LED_D5 | LED_D8,

	/* For testing of the multi-color LEDs - see gpio-ex prog */
	[LEDMAN_LAN3_RX]   = LED_D3_RD,
	[LEDMAN_LAN3_TX]   = LED_D3_BL,
	[LEDMAN_LAN3_LINK] = LED_D3_GR,
	[LEDMAN_LAN3_DHCP] = LED_D6_RD,
	[LEDMAN_FAILOVER]  = LED_D6_BL,
	[LEDMAN_HIGHAVAIL] = LED_D6_GR,
};

static leddef_t	ledman_def = {
	/* [LEDS_FLASH] = LED_D3_GR, */
};
